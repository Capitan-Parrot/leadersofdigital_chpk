...
export const Chat = observer(() => {
  return (
    <section
      className="rounded-t-3xl min-h-full max-w-6xl mx-auto w-full max-h-full overflow-hidden border-primary/10 items-center px-8 pb-6 flex flex-col h-full"
      style={{
        background:
    ...
    >
      <div className="w-full max-w-3xl flex-1 flex flex-col h-full">
        <MessageList />
        <TextField onSubmit={console.log} />
      </div>
    </section>
  );
});
